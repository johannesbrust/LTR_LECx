%-------------------- EXPERIMENT_IV_IPOPT_RERUN_SELECTEDb ---------------%%
...
% 06/07/21, J.B., Second selection of problems
%--------------------------------------------------------------------------
...
options_ipopt.ipopt.max_iter = 100000; % 3000, 10000
...
save(fullfile(datapath,'EXPERIMENT_IV_EXT_IPOPT_RERUN_SELECTEDb'),...
