...
% Version 2
options.whichAsolve = 3;
options.whichInit = 2;
[x_sc,f_sc,out_sc] = LTRSC_LEC_V2(fun,const,x0,options);

% Version 2 with Initialization 1
options.whichInit = 1;
[x_scI1,f_scI1,out_scI1] = LTRSC_LEC_V2(fun,const,x0,options);
